...
/***/ function(module, exports, __webpack_require__) {
	...
	/* eslint-disable */
	// Libs
	var chalk = __webpack_require__(291);
	var program = __webpack_require__(299);
	var fs = __webpack_require__(305);
	var moment = __webpack_require__(359);
	var co = __webpack_require__(458);
	var prompt = __webpack_require__(459);

	var templateJSON = __webpack_require__(462);
	...
	program.version('0.0.1').command('new [template]').alias('n').description('create a new note for the day').action(function (template, cmd) {
	  if (!template) {
	    template = 'default';
	  }
	  var today = moment().format("DD-MM-YYYY");
	...
	program.command('init').description('initializes notes').action(function (cmd) {
	  cmdValue = cmd;
	  co(regeneratorRuntime.mark(function _callee() {
	    var notesDirPath, homePath, shouldCreate;
	    return regeneratorRuntime.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            _context.next = 2;
	            return prompt('notes directory path (from $HOME): ');

	          case 2:
	            notesDirPath = _context.sent;
	            homePath = process.env['HOME'] + '/' + notesDirPath;

	            initializeNotes(homePath);

	            _context.next = 7;
	            return prompt.confirm('Would you like me to create "' + homePath + '" for you?(Recommended) [y/N] ');
	...
	program.command('add [cli-ref] <notes...>').alias('a').description('add note to object').action(function (ref, note, cmd) {
	  try {
	    addNote(note, ref);
	...
	program.command('remove [cli-ref] <index>').alias('r').description('remove note from note object').action(function (ref, note, cmd) {
	  try {
	    removeNote(note, ref);
	...
	program.command('complete [cli-ref] <index>').alias('c').description('mark item as complete').action(function (ref, note, cmd) {
	  try {
	...
	program.command('incomplete [cli-ref] <index>').alias('i').description('mark item as incomplete').action(function (ref, note, cmd) {
	  try {
	...
	program.command('failed [cli-ref] <index>').alias('f').description('mark item as failed').action(function (ref, note, cmd) {
	  try {
	    failNote(note, ref);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var escapeStringRegexp = __webpack_require__(292);
	var ansiStyles = __webpack_require__(293);
	var stripAnsi = __webpack_require__(295);
	var hasAnsi = __webpack_require__(297);
	var supportsColor = __webpack_require__(298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var ansiRegex = __webpack_require__(296)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEmitter = __webpack_require__(300).EventEmitter;
	var spawn = __webpack_require__(301).spawn;
	var readlink = __webpack_require__(302).readlinkSync;
	var path = __webpack_require__(304);
	var dirname = path.dirname;
	var basename = path.basename;
	var fs = __webpack_require__(303);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fse = {}
	var gfs = __webpack_require__(307)
	...
	assign(fs, __webpack_require__(315))
	assign(fs, __webpack_require__(323))
	assign(fs, __webpack_require__(320))
	assign(fs, __webpack_require__(326))
	assign(fs, __webpack_require__(340))
	assign(fs, __webpack_require__(345))
	assign(fs, __webpack_require__(346))
	assign(fs, __webpack_require__(348))
	assign(fs, __webpack_require__(349))
	assign(fs, __webpack_require__(355))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs = __webpack_require__(303)
	var polyfills = __webpack_require__(308)
	var legacy = __webpack_require__(311)
	var queue = []
	...
	if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
	  process.on('exit', function() {
	    debug(queue)
	    __webpack_require__(314).equal(queue.length, 0)
	  })
	}

	module.exports = patch(__webpack_require__(309))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var constants = __webpack_require__(310)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs = __webpack_require__(307)
	var path = __webpack_require__(304)
	var ncp = __webpack_require__(317)
	var mkdir = __webpack_require__(320)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs = __webpack_require__(307)
	var path = __webpack_require__(304)
	var utimes = __webpack_require__(318)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  mkdirs: __webpack_require__(321),
	  mkdirsSync: __webpack_require__(322),
	  // alias
	  mkdirp: __webpack_require__(321),
	  mkdirpSync: __webpack_require__(322),
	  ensureDir: __webpack_require__(321),
	  ensureDirSync: __webpack_require__(322)
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  copySync: __webpack_require__(324)
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs = __webpack_require__(307)
	var path = __webpack_require__(304)
	var copyFileSync = __webpack_require__(325)
	var mkdir = __webpack_require__(320)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rimraf = __webpack_require__(327)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var path = __webpack_require__(304)
	var fs = __webpack_require__(303)
	var glob = __webpack_require__(328)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs = __webpack_require__(303)
	var minimatch = __webpack_require__(329)
	var Minimatch = minimatch.Minimatch
	var inherits = __webpack_require__(333)
	var EE = __webpack_require__(300).EventEmitter
	var path = __webpack_require__(304)
	var assert = __webpack_require__(314)
	var isAbsolute = __webpack_require__(334)
	...
	var inflight = __webpack_require__(337)
	var util = __webpack_require__(313)
	var childrenIgnored = common.childrenIgnored
	var isIgnored = common.isIgnored

	var once = __webpack_require__(339)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var path = { sep: '/' }
	try {
	  path = __webpack_require__(304)
	} catch (er) {}

	var GLOBSTAR = minimatch.GLOBSTAR = Minimatch.GLOBSTAR = {}
	var expand = __webpack_require__(330)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var concatMap = __webpack_require__(331);
	var balanced = __webpack_require__(332);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(313).inherits
...
/***/ function(module, exports, __webpack_require__) {
	...
	var minimatch = __webpack_require__(329)
	var Minimatch = minimatch.Minimatch
	var Glob = __webpack_require__(328).Glob
	var util = __webpack_require__(313)
	var path = __webpack_require__(304)
	var assert = __webpack_require__(314)
	var isAbsolute = __webpack_require__(334)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var wrappy = __webpack_require__(338)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jsonFile = __webpack_require__(341)

	jsonFile.outputJsonSync = __webpack_require__(343)
	jsonFile.outputJson = __webpack_require__(344)
	// aliases
	jsonFile.outputJSONSync = __webpack_require__(343)
	jsonFile.outputJSON = __webpack_require__(344)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jsonFile = __webpack_require__(342)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var path = __webpack_require__(304)
	var rimraf = __webpack_require__(327)
	var mkdirp = __webpack_require__(320).mkdirs
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  createOutputStream: __webpack_require__(347)
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var path = __webpack_require__(304)
	var mkdir = __webpack_require__(320)
	var remove = __webpack_require__(326)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var file = __webpack_require__(350)
	var link = __webpack_require__(351)
	var symlink = __webpack_require__(352)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var path = __webpack_require__(304)
	var fs = __webpack_require__(307)
	var _mkdirs = __webpack_require__(320)
	var mkdirs = _mkdirs.mkdirs
	var mkdirsSync = _mkdirs.mkdirsSync

	var _symlinkPaths = __webpack_require__(353)
	var symlinkPaths = _symlinkPaths.symlinkPaths
	var symlinkPathsSync = _symlinkPaths.symlinkPathsSync

	var _symlinkType = __webpack_require__(354)
...
/***/ function(module, exports, __webpack_require__) {
	...
	path.isAbsolute = (path.isAbsolute) ? path.isAbsolute : __webpack_require__(334)
	var fs = __webpack_require__(307)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var klaw = __webpack_require__(357)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs = __webpack_require__(303)
	var path = __webpack_require__(304)
	var Readable = __webpack_require__(312).Readable
	var util = __webpack_require__(313)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var keypress = __webpack_require__(460);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function keypress(stream) {
	  ...
	  var StringDecoder = __webpack_require__(461).StringDecoder; // lazy load
	...
	module.exports = {
		"Daily Objectives": {
			...
			"items": [
				...
				{
					"description": "speak a foreign language",
					"status": "incomplete"
				}
			]
		},

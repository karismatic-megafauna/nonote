  ...
  _fsExtra2.default.readJson(configPath, (err, configObj) => {
    ...
    _fsExtra2.default.mkdirs(todayPath, err => {
      ...
      _fsExtra2.default.copy(templateDataPath, dataJSONPath, err => {
        ...
        _fsExtra2.default.readJson(yesterdayDataJSONPath, (err, yesterdayData) => {
          ...
          _fsExtra2.default.readJson(dataJSONPath, (err, dataJSON) => {
            ...
            if (hasPreviousNote && incompleteSections.length > 0) {
              incompleteSections.forEach(incompleteSection => {
                console.log(`\nCopying ${_chalk2.default.yellow(incompleteSection.title)} incomplete tasks from yesterday:`);
            ...
            _fsExtra2.default.writeJson(dataJSONPath, dataJSON, err => {
